...
async function seedData() {
	const query1 = `SELECT COUNT(paper_id), COUNT(DISTINCT author_id) FROM rsrch_papers`;

	const query2 = `SELECT COUNT(paper_title) FROM rsrch_papers AS rp , 
	...
	const query4 = `SELECT AVG(h_index), university FROM authors AS a inner join rsrch_papers 
